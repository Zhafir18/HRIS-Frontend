        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left mr-1">
              <p className="text-xs font-bold text-slate-800 leading-tight">{user?.username || "Account"}</p>
              <p className="text-[10px] text-slate-500 font-medium">{user?.role?.name || "Member"}</p>
            </div>
            ...
            <>
              ...
              <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-2xl border border-slate-100 py-2 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                {user?.role?.name === "Admin" && (
                  ...
                  >
                    <svg className="w-4 h-4 mr-3 text-slate-400 group-hover:text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <svg className="w-4 h-4 mr-3 text-rose-400 group-hover:text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
